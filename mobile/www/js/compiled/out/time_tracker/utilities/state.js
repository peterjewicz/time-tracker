...
return Promise.all(cljs.core.map.call(null,(function (p1__22415_SHARP_){
return module$Applications$server$time_tracker$node_modules$localforage$dist$localforage["default"].getItem(p1__22415_SHARP_).then((function (v){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__22415_SHARP_,v], null);
}));
...
//# sourceMappingURL=state.js.map?rel=1556144015898
