...
goog.addDependency("../time_tracker/scripts/db.js", ['time_tracker.scripts.db'], ['cljs.core', 'time_tracker.utilities.state', 'module$Applications$server$time_tracker$node_modules$localforage$dist$localforage']);
goog.addDependency("../time_tracker/utilities/date_formatter.js", ['time_tracker.utilities.date_formatter'], ['reagent.core', 'cljs.core']);
goog.addDependency("../time_tracker/components/Project_view.js", ['time_tracker.components.Project_view'], ['time_tracker.utilities.view_handler', 'module$Applications$server$time_tracker$node_modules$moment$moment', 'reagent.core', 'cljs.core', 'time_tracker.scripts.db', 'module$Applications$server$time_tracker$node_modules$localforage$dist$localforage', 'time_tracker.utilities.date_formatter']);
...
goog.addDependency("../time_tracker/components/toast.js", ['time_tracker.components.toast'], ['cljs.core']);
goog.addDependency("../time_tracker/components/New.js", ['time_tracker.components.New'], ['time_tracker.utilities.view_handler', 'time_tracker.components.toast', 'reagent.core', 'cljs.core', 'time_tracker.utilities.state', 'module$Applications$server$time_tracker$node_modules$localforage$dist$localforage']);
