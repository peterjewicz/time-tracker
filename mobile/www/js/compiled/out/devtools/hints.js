...
var file = cljs.core.get.call(null,map__25724__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__25724__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__25724__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e25723){var _e = e25723;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___25726 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___25726)){
var seen_errors_25727 = temp__5455__auto___25726;
if(cljs.core.truth_(seen_errors_25727.has(self))){
} else {
seen_errors_25727.add(self);

var temp__5457__auto___25728 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___25728)){
var sense_25729 = temp__5457__auto___25728;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_25729)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1544380204860
