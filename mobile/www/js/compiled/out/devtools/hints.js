...
var line = cljs.core.get.call(null,map__26263__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__26263__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e26262){var _e = e26262;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___26265 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___26265)){
var seen_errors_26266 = temp__5455__auto___26265;
if(cljs.core.truth_(seen_errors_26266.has(self))){
} else {
seen_errors_26266.add(self);

var temp__5457__auto___26267 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___26267)){
var sense_26268 = temp__5457__auto___26267;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26268)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1582304848295
