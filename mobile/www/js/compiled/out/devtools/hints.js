...
var reader = (function (){var or__3922__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__3922__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
return (128);
...
var file = cljs.core.get.call(null,map__26236__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__26236__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__26236__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e26235){var _e = e26235;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___26238 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___26238)){
var seen_errors_26239 = temp__5455__auto___26238;
if(cljs.core.truth_(seen_errors_26239.has(self))){
} else {
seen_errors_26239.add(self);

var temp__5457__auto___26240 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___26240)){
var sense_26241 = temp__5457__auto___26240;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26241)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1556144024182
