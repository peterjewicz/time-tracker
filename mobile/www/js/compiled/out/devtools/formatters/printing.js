...
var len__4499__auto___23534 = arguments.length;
var i__4500__auto___23535 = (0);
while(true){
if((i__4500__auto___23535 < len__4499__auto___23534)){
args__4502__auto__.push((arguments[i__4500__auto___23535]));

var G__23536 = (i__4500__auto___23535 + (1));
i__4500__auto___23535 = G__23536;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23531){
var G__23532 = cljs.core.first.call(null,seq23531);
var seq23531__$1 = cljs.core.next.call(null,seq23531);
var G__23533 = cljs.core.first.call(null,seq23531__$1);
var seq23531__$2 = cljs.core.next.call(null,seq23531__$1);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23532,G__23533,seq23531__$2);
});
...
if(cljs.core.truth_((function (){var or__3922__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
return cljs.core._write.call(null,writer__4162__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__3911__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__3911__auto__){
var or__3922__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23537_SHARP_){
return !((cljs.core.meta.call(null,p1__23537_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__23538__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23542){var _e__22522__auto__ = e23542;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e23544){var _e__22522__auto__ = e23544;
return false;
}}
})())){
...
var _STAR_current_state_STAR_23546 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__23547 = opts;
...
var markup_db = cljs.core.get.call(null,map__23547__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_23546;
}});
...
;
var temp__5455__auto___23551 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___23551)){
var managed_print_level_23552 = temp__5455__auto___23551;
var _STAR_print_level_STAR_23550_23553 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_23552;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_23550_23553,managed_print_level_23552,temp__5455__auto___23551,writer,opts,job_fn){
return (function (p1__23549_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__23549_SHARP_,null);
});})(_STAR_print_level_STAR_23550_23553,managed_print_level_23552,temp__5455__auto___23551,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_23550_23553;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1544380200534
