...
var G__24044 = devtools.prefs.pref.call(null,v);
v = G__24044;
continue;
} else {
return v;
...
}catch (e24047){var _e__23061__auto__ = e24047;
return false;
}})();
...
}catch (e24051){var _e__23061__auto__ = e24051;
return false;
}})();
...
}catch (e24053){var _e__23061__auto__ = e24053;
return false;
}}
}
});
...
var vec__24055 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__24055,(0),null);
var name = cljs.core.nth.call(null,vec__24055,(1),null);
...
return cljs.core.some.call(null,(function (p1__24058_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__24058_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1582304842513
