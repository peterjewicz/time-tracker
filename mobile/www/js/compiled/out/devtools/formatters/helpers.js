...
var G__24017 = devtools.prefs.pref.call(null,v);
v = G__24017;
continue;
} else {
return v;
...
var and__3911__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__3911__auto__){
var and__3911__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__3922__auto__ = (function (){try{if(!((value == null))){
...
}catch (e24020){var _e__23034__auto__ = e24020;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
var or__3922__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e24024){var _e__23034__auto__ = e24024;
return false;
}})();
...
}catch (e24026){var _e__23034__auto__ = e24026;
return false;
}}
}
});
...
var and__3911__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__3911__auto____$1){
...
var or__3922__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
var and__3911__auto__ = (function (){var or__3922__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
var vec__24028 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__24028,(0),null);
var name = cljs.core.nth.call(null,vec__24028,(1),null);
...
var and__3911__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__3911__auto__)){
...
var or__3922__auto__ = typeof value === 'string';
if(or__3922__auto__){
return or__3922__auto__;
} else {
var or__3922__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__24031_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__24031_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1556144018935
