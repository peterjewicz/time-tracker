...
var o23942 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23942["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23943 = temp__5455__auto____$1;
return (o23943["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__23054__auto__ = f;
return (o__23054__auto__["toString"]).call(o__23054__auto__);
} else {
return "";
}
}catch (e23944){var _ = e23944;
return "";
}});
...
try{var o__23054__auto___23946 = t;
(o__23054__auto___23946["cljs$lang$ctorPrWriter"]).call(o__23054__auto___23946,t,writer);
}catch (e23945){var __23947 = e23945;
}
...
var char_code = (function (){var o__23054__auto__ = (new String(char$));
return (o__23054__auto__["charCodeAt"]).call(o__23054__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__23054__auto__ = String;
return (o__23054__auto__["fromCharCode"]).call(o__23054__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23948 = num_code;
switch (G__23948) {
case (1):
return (185);
...
var o__23054__auto__ = String;
return (o__23054__auto__["fromCharCode"]).call(o__23054__auto__,superscript_code);
});
/**
...
}catch (e23950){var _e__23061__auto__ = e23950;
return false;
}})())){
...
var vec__23951 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23951,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23954 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23954["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23955 = temp__5455__auto____$1;
return (o23955["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23958){
var vec__23959 = p__23958;
var ns_detector = cljs.core.nth.call(null,vec__23959,(0),null);
...
var G__23965 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23966 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23965;
remaining_tokens = G__23966;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23956){
var G__23957 = cljs.core.first.call(null,seq23956);
var seq23956__$1 = cljs.core.next.call(null,seq23956);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23957,seq23956__$1);
});
...
var vec__23970 = cljs.core.split_with.call(null,(function (p1__23969_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23969_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23970,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23970,(1),null);
...
var vec__23973 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23973,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23973,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23976 = cljs.core.rest.call(null,remaining_tokens);
var G__23977 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23976;
name_tokens = G__23977;
continue;
} else {
...
var vec__23980 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23980,(0),null);
var arity = cljs.core.nth.call(null,vec__23980,(1),null);
var vec__23983 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23983,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23983,(1),null);
var vec__23986 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23986,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23986,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23986,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23986,(3),null);
...
var vec__23992 = result;
var munged_ns = cljs.core.nth.call(null,vec__23992,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23992,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23992,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23992,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23992,(4),null);
var arity = cljs.core.nth.call(null,vec__23992,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23996 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23996,(0),null);
var args = cljs.core.nth.call(null,vec__23996,(1),null);
var vec__23999 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23999,(0),null);
var name = cljs.core.nth.call(null,vec__23999,(1),null);
...
var G__24002 = (arity + (1));
var G__24003 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__24004){
var vec__24005 = p__24004;
var arity = cljs.core.nth.call(null,vec__24005,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__24005,(1),null);
...
return cljs.core.get.call(null,arities,p1__24008_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__24009_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__24012){
var vec__24013 = p__24012;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__24013,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq24010){
var G__24011 = cljs.core.first.call(null,seq24010);
var seq24010__$1 = cljs.core.next.call(null,seq24010);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__24011,seq24010__$1);
});
...
var G__24019 = arg;
var G__24019__$1 = (((G__24019 instanceof cljs.core.Keyword))?G__24019.fqn:null);
switch (G__24019__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__24021__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24021__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24021__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24021__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24022 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24022,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24022,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24022,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24022,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24022,(4),null);
var arity = cljs.core.nth.call(null,vec__24022,(5),null);
...
var o__23054__auto__ = f;
return (o__23054__auto__["getBasis"]).call(o__23054__auto__);
});
/**
...
}catch (e24026){var _e__23061__auto__ = e24026;
...
var G__24027 = (obj[cljs.core.first.call(null,path)]);
var G__24028 = cljs.core.rest.call(null,path);
obj = G__24027;
path = G__24028;
continue;
} else {
...
return (function (accum,p__24029){
var vec__24030 = p__24029;
var bit = cljs.core.nth.call(null,vec__24030,(0),null);
var protocol = cljs.core.nth.call(null,vec__24030,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24033){
var vec__24034 = p__24033;
var ns = cljs.core.nth.call(null,vec__24034,(0),null);
var name = cljs.core.nth.call(null,vec__24034,(1),null);
var selector = cljs.core.nth.call(null,vec__24034,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__24039,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24039,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__24039,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__24037_SHARP_){
return (obj[cljs.core.first.call(null,p1__24037_SHARP_)]);
});})(name,sorted_matches,vec__24039,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1582304842393
