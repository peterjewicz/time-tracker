...
var o23915 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23915["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23916 = temp__5455__auto____$1;
return (o23916["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__23027__auto__ = f;
return (o__23027__auto__["toString"]).call(o__23027__auto__);
} else {
return "";
}
}catch (e23917){var _ = e23917;
return "";
}});
...
try{var o__23027__auto___23919 = t;
(o__23027__auto___23919["cljs$lang$ctorPrWriter"]).call(o__23027__auto___23919,t,writer);
}catch (e23918){var __23920 = e23918;
}
...
var char_code = (function (){var o__23027__auto__ = (new String(char$));
return (o__23027__auto__["charCodeAt"]).call(o__23027__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__23027__auto__ = String;
return (o__23027__auto__["fromCharCode"]).call(o__23027__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23921 = num_code;
switch (G__23921) {
case (1):
return (185);
...
var o__23027__auto__ = String;
return (o__23027__auto__["fromCharCode"]).call(o__23027__auto__,superscript_code);
});
/**
...
}catch (e23923){var _e__23034__auto__ = e23923;
return false;
}})())){
...
var vec__23924 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23924,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23927 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23927["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23928 = temp__5455__auto____$1;
return (o23928["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23931){
var vec__23932 = p__23931;
var ns_detector = cljs.core.nth.call(null,vec__23932,(0),null);
...
var G__23938 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23939 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23938;
remaining_tokens = G__23939;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23929){
var G__23930 = cljs.core.first.call(null,seq23929);
var seq23929__$1 = cljs.core.next.call(null,seq23929);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23930,seq23929__$1);
});
...
var vec__23943 = cljs.core.split_with.call(null,(function (p1__23942_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23942_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23943,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23943,(1),null);
...
var vec__23946 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23946,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23946,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23949 = cljs.core.rest.call(null,remaining_tokens);
var G__23950 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23949;
name_tokens = G__23950;
continue;
} else {
...
var vec__23953 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23953,(0),null);
var arity = cljs.core.nth.call(null,vec__23953,(1),null);
var vec__23956 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23956,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23956,(1),null);
var vec__23959 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23959,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23959,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23959,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23959,(3),null);
...
var vec__23965 = result;
var munged_ns = cljs.core.nth.call(null,vec__23965,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23965,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23965,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23965,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23965,(4),null);
var arity = cljs.core.nth.call(null,vec__23965,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23969 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23969,(0),null);
var args = cljs.core.nth.call(null,vec__23969,(1),null);
var vec__23972 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23972,(0),null);
var name = cljs.core.nth.call(null,vec__23972,(1),null);
...
var G__23975 = (arity + (1));
var G__23976 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23977){
var vec__23978 = p__23977;
var arity = cljs.core.nth.call(null,vec__23978,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23978,(1),null);
...
return cljs.core.get.call(null,arities,p1__23981_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23982_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23985){
var vec__23986 = p__23985;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23986,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23983){
var G__23984 = cljs.core.first.call(null,seq23983);
var seq23983__$1 = cljs.core.next.call(null,seq23983);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23984,seq23983__$1);
});
...
var G__23992 = arg;
var G__23992__$1 = (((G__23992 instanceof cljs.core.Keyword))?G__23992.fqn:null);
switch (G__23992__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23994__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23994__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23994__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23994__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23995 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23995,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23995,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23995,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23995,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23995,(4),null);
var arity = cljs.core.nth.call(null,vec__23995,(5),null);
...
var o__23027__auto__ = f;
return (o__23027__auto__["getBasis"]).call(o__23027__auto__);
});
/**
...
}catch (e23999){var _e__23034__auto__ = e23999;
...
var G__24000 = (obj[cljs.core.first.call(null,path)]);
var G__24001 = cljs.core.rest.call(null,path);
obj = G__24000;
path = G__24001;
continue;
} else {
...
return (function (accum,p__24002){
var vec__24003 = p__24002;
var bit = cljs.core.nth.call(null,vec__24003,(0),null);
var protocol = cljs.core.nth.call(null,vec__24003,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24006){
var vec__24007 = p__24006;
var ns = cljs.core.nth.call(null,vec__24007,(0),null);
var name = cljs.core.nth.call(null,vec__24007,(1),null);
var selector = cljs.core.nth.call(null,vec__24007,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__24012,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24012,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__24012,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__24010_SHARP_){
return (obj[cljs.core.first.call(null,p1__24010_SHARP_)]);
});})(name,sorted_matches,vec__24012,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1556144018815
