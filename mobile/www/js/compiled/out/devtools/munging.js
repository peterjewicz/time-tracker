...
var o23923 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23923["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23924 = temp__5455__auto____$1;
return (o23924["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__23035__auto__ = f;
return (o__23035__auto__["toString"]).call(o__23035__auto__);
} else {
return "";
}
}catch (e23925){var _ = e23925;
return "";
}});
...
try{var o__23035__auto___23927 = t;
(o__23035__auto___23927["cljs$lang$ctorPrWriter"]).call(o__23035__auto___23927,t,writer);
}catch (e23926){var __23928 = e23926;
}
...
var char_code = (function (){var o__23035__auto__ = (new String(char$));
return (o__23035__auto__["charCodeAt"]).call(o__23035__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__23035__auto__ = String;
return (o__23035__auto__["fromCharCode"]).call(o__23035__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23929 = num_code;
switch (G__23929) {
case (1):
return (185);
...
var o__23035__auto__ = String;
return (o__23035__auto__["fromCharCode"]).call(o__23035__auto__,superscript_code);
});
/**
...
}catch (e23931){var _e__23042__auto__ = e23931;
return false;
}})())){
...
var vec__23932 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23932,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23935 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23935["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23936 = temp__5455__auto____$1;
return (o23936["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23939){
var vec__23940 = p__23939;
var ns_detector = cljs.core.nth.call(null,vec__23940,(0),null);
...
var G__23946 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23947 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23946;
remaining_tokens = G__23947;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23937){
var G__23938 = cljs.core.first.call(null,seq23937);
var seq23937__$1 = cljs.core.next.call(null,seq23937);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23938,seq23937__$1);
});
...
var vec__23951 = cljs.core.split_with.call(null,(function (p1__23950_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23950_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23951,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23951,(1),null);
...
var vec__23954 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23954,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23954,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23957 = cljs.core.rest.call(null,remaining_tokens);
var G__23958 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23957;
name_tokens = G__23958;
continue;
} else {
...
var vec__23961 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23961,(0),null);
var arity = cljs.core.nth.call(null,vec__23961,(1),null);
var vec__23964 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23964,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23964,(1),null);
var vec__23967 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23967,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23967,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23967,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23967,(3),null);
...
var vec__23973 = result;
var munged_ns = cljs.core.nth.call(null,vec__23973,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23973,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23973,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23973,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23973,(4),null);
var arity = cljs.core.nth.call(null,vec__23973,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23977 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23977,(0),null);
var args = cljs.core.nth.call(null,vec__23977,(1),null);
var vec__23980 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23980,(0),null);
var name = cljs.core.nth.call(null,vec__23980,(1),null);
...
var G__23983 = (arity + (1));
var G__23984 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23985){
var vec__23986 = p__23985;
var arity = cljs.core.nth.call(null,vec__23986,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23986,(1),null);
...
return cljs.core.get.call(null,arities,p1__23989_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23990_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23993){
var vec__23994 = p__23993;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23994,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23991){
...
var G__24000 = arg;
var G__24000__$1 = (((G__24000 instanceof cljs.core.Keyword))?G__24000.fqn:null);
switch (G__24000__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__24002__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__24002__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__24002__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__24002__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__24003 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__24003,(0),null);
var fn_name = cljs.core.nth.call(null,vec__24003,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__24003,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__24003,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__24003,(4),null);
var arity = cljs.core.nth.call(null,vec__24003,(5),null);
...
var o__23035__auto__ = f;
return (o__23035__auto__["getBasis"]).call(o__23035__auto__);
});
/**
...
}catch (e24007){var _e__23042__auto__ = e24007;
...
var G__24008 = (obj[cljs.core.first.call(null,path)]);
var G__24009 = cljs.core.rest.call(null,path);
obj = G__24008;
path = G__24009;
continue;
} else {
...
return (function (accum,p__24010){
var vec__24011 = p__24010;
var bit = cljs.core.nth.call(null,vec__24011,(0),null);
var protocol = cljs.core.nth.call(null,vec__24011,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__24014){
var vec__24015 = p__24014;
var ns = cljs.core.nth.call(null,vec__24015,(0),null);
var name = cljs.core.nth.call(null,vec__24015,(1),null);
var selector = cljs.core.nth.call(null,vec__24015,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__24020,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__24020,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__24020,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__24018_SHARP_){
return (obj[cljs.core.first.call(null,p1__24018_SHARP_)]);
});})(name,sorted_matches,vec__24020,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1570412436887
