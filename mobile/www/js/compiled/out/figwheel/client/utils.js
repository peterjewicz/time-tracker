...
return (new CustomEvent(event_name,(function (){var obj29693 = {"detail":data};
return obj29693;
})()));
} else {
...
var f = (function (){var pred__29700 = cljs.core._EQ_;
var expr__29701 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29700.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29701))){
return ((function (pred__29700,expr__29701){
return (function (p1__29694_SHARP_){
return console.warn(p1__29694_SHARP_);
});
;})(pred__29700,expr__29701))
} else {
if(cljs.core.truth_(pred__29700.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29701))){
return ((function (pred__29700,expr__29701){
return (function (p1__29695_SHARP_){
return console.debug(p1__29695_SHARP_);
});
;})(pred__29700,expr__29701))
} else {
if(cljs.core.truth_(pred__29700.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29701))){
return ((function (pred__29700,expr__29701){
return (function (p1__29696_SHARP_){
return console.error(p1__29696_SHARP_);
});
;})(pred__29700,expr__29701))
} else {
return ((function (pred__29700,expr__29701){
return (function (p1__29697_SHARP_){
return console.log(p1__29697_SHARP_);
});
;})(pred__29700,expr__29701))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29704){
...
var eval_fn = cljs.core.get.call(null,map__29705__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29707_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__29709,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1582304851022
