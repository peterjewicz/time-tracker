...
return (new CustomEvent(event_name,(function (){var obj29674 = {"detail":data};
return obj29674;
})()));
} else {
...
var f = (function (){var pred__29681 = cljs.core._EQ_;
var expr__29682 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29681.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29682))){
return ((function (pred__29681,expr__29682){
return (function (p1__29675_SHARP_){
return console.warn(p1__29675_SHARP_);
});
;})(pred__29681,expr__29682))
} else {
if(cljs.core.truth_(pred__29681.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29682))){
return ((function (pred__29681,expr__29682){
return (function (p1__29676_SHARP_){
return console.debug(p1__29676_SHARP_);
});
;})(pred__29681,expr__29682))
} else {
if(cljs.core.truth_(pred__29681.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29682))){
return ((function (pred__29681,expr__29682){
return (function (p1__29677_SHARP_){
return console.error(p1__29677_SHARP_);
});
;})(pred__29681,expr__29682))
} else {
return ((function (pred__29681,expr__29682){
return (function (p1__29678_SHARP_){
return console.log(p1__29678_SHARP_);
});
;})(pred__29681,expr__29682))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29685){
...
var eval_fn = cljs.core.get.call(null,map__29686__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29688_SHARP_);
});})(new_def))
);
...
return (function (p__29689){
var vec__29690 = p__29689;
var ky = cljs.core.nth.call(null,vec__29690,(0),null);
...
}catch (e29695){if((e29695 instanceof Error)){
var e = e29695;
return not_found;
} else {
throw e29695;
...
//# sourceMappingURL=utils.js.map?rel=1570412447344
