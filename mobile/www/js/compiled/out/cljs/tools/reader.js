...
var G__25885 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__25885;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__25886 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__25886,ch);
...
if(("\\" === ch__$1)){
var ch_25887__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_25887__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_25887__$2);
} else {
}

var G__25888 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__25888;
continue;
}
}
...
var vec__25896 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__25896,(0),null);
var start_column = cljs.core.nth.call(null,vec__25896,(1),null);
...
var G__25899 = cljs.core.conj_BANG_.call(null,a,form);
a = G__25899;
continue;
}
}
...
var _STAR_read_delim_STAR_25900 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_25900;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__25901 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__25901,(0),null);
var start_column = cljs.core.nth.call(null,vec__25901,(1),null);
...
var vec__25904 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__25904,(0),null);
var end_column = cljs.core.nth.call(null,vec__25904,(1),null);
...
var vec__25907 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__25907,(0),null);
var start_column = cljs.core.nth.call(null,vec__25907,(1),null);
...
var vec__25910 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__25910,(0),null);
var end_column = cljs.core.nth.call(null,vec__25910,(1),null);
...
var vec__25913 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__25913,(0),null);
var start_column = cljs.core.nth.call(null,vec__25913,(1),null);
...
var vec__25916 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__25916,(0),null);
var end_column = cljs.core.nth.call(null,vec__25916,(1),null);
...
var sb = (function (){var G__25919 = (new goog.string.StringBuffer());
G__25919.append(initch);
...
var G__25921 = (function (){var G__25920 = sb;
G__25920.append(ch);

return G__25920;
})();
var G__25922 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__25921;
ch = G__25922;
continue;
}
...
switch (G__25925) {
case "\\":
var G__25929 = (function (){var G__25926 = sb;
G__25926.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__25926;
})();
var G__25930 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__25929;
ch = G__25930;
continue;
...
break;
default:
var G__25931 = (function (){var G__25927 = sb;
G__25927.append(ch);

return G__25927;
})();
var G__25932 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__25931;
ch = G__25932;
continue;
...
var vec__25933 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__25933,(0),null);
var end_column = cljs.core.nth.call(null,vec__25933,(1),null);
...
var vec__25936 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
...
var vec__25941 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__25941,(0),null);
var column = cljs.core.nth.call(null,vec__25941,(1),null);
...
var vec__25946 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__25946,(0),null);
var column = cljs.core.nth.call(null,vec__25946,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__25951 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__25951,(0),null);
var start_column = cljs.core.nth.call(null,vec__25951,(1),null);
...
var vec__25954 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__25954,(0),null);
var end_column = cljs.core.nth.call(null,vec__25954,(1),null);
...
var G__25957 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__25957,true,null,opts,pending_forms);
...
var G__25958 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__25958)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__25958)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__25958)){
...
var _STAR_suppress_read_STAR_25959 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_25959;
}});
...
var G__25960 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__25960,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__25960,rdr,first_line);
...
var G__25964 = matched;
var G__25965 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__25964;
finished = G__25965;
continue;
} else {
...
var _STAR_suppress_read_STAR_25966 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_25966;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env25967 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__25968 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__25968,"(");
...
var G__25969 = (i + (1));
var G__25970 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env25967;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__25971 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__25971);
...
var G__25972 = cljs.core.next.call(null,s__$1);
var G__25973 = ret;
s__$1 = G__25972;
r = G__25973;
continue;
...
var G__25974 = cljs.core.next.call(null,s);
var G__25975 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__25974;
key_vals = G__25975;
continue;
} else {
...
var gensym_env25979 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env25979;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__25980 = token;
var G__25980__$1 = (((G__25980 == null))?null:cljs.core.subs.call(null,G__25980,(1)));
var G__25980__$2 = (((G__25980__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__25980__$1));
var G__25980__$3 = (((G__25980__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__25980__$2));
var G__25980__$4 = (((G__25980__$3 == null))?null:cljs.core.symbol.call(null,G__25980__$3));
if((G__25980__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__25980__$4);
}
})():(function (){var G__25981 = token;
var G__25981__$1 = (((G__25981 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__25981));
if((G__25981__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__25981__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__25992,reader){
var map__25993 = p__25992;
var map__25993__$1 = ((((!((map__25993 == null)))?(((((map__25993.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25993.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25993):map__25993);
var opts = map__25993__$1;
var eof = cljs.core.get.call(null,map__25993__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq25999){
var G__26000 = cljs.core.first.call(null,seq25999);
var seq25999__$1 = cljs.core.next.call(null,seq25999);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26000,seq25999__$1);
});


//# sourceMappingURL=reader.js.map?rel=1570412442557
